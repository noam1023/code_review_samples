...
public class InvertedIndexInsensitive implements AbstractInvertedIndex {


    private static InvertedIndexInsensitive invertedIndexInsensitive;
    private InvertedIndexInsensitive(){}


    public static InvertedIndexInsensitive getInstance(){
        if (invertedIndexInsensitive==null){
            invertedIndexInsensitive = new InvertedIndexInsensitive();
    ...
    public TreeSet<String> runQuery(String query)
    {
        ...
        for (String word : split_query) {
            ...
            else if (word.equals("NOT"))
            {
                ...
                HashSet<Integer> word1 = myHashMap.get(word.toLowerCase());
                myStack.push(word1);
            }
        }
